...
INSERT INTO configuracion (clave, valor, descripcion, categoria, tipo) 
VALUES ('paypal_client_id', 'Ads5V1Ttz4gtLmCYSZBxErKYdsA5hc4XvqyE7FVfM7WRLzO-DNuNtXUtzq6GvhMUUvOxiens7EnBeMXD', 'Client ID de PayPal para pagos', 'PayPal', 'text')
...
INSERT INTO configuracion (clave, valor, descripcion, categoria, tipo) 
VALUES ('paypal_secret', 'EJ6hBDoya6zU3iHQDDrSL-nklSDUbvgVuHVgg9MnwBbVrhJq9MKYV_PsOnKYqKiUy5vQVc5ipxuRcpvv', 'Secret Key de PayPal', 'PayPal', 'password')
...
INSERT INTO configuracion (clave, valor, descripcion, categoria, tipo) 
VALUES ('paypal_mode', 'sandbox', 'Modo de operación de PayPal (sandbox o live)', 'PayPal', 'select')
ON DUPLICATE KEY UPDATE valor = 'sandbox';

-- Actualizar nombre de la aplicación
INSERT INTO configuracion (clave, valor, descripcion, categoria, tipo) 
VALUES ('paypal_app_name', 'Canaco', 'Nombre de la aplicación en PayPal', 'PayPal', 'text')
