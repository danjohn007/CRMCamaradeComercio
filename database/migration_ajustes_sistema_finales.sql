...
-- 1. Agregar campo para evidencia en movimientos financieros (si no existe)
-- La evidencia es obligatoria a nivel de aplicación para nuevos movimientos
...
-- Nota: Se removió la constraint UNIQUE para permitir duplicados legítimos
-- Los duplicados se manejan a nivel de aplicación con mejor lógica de inserción
...
-- 10. Nota: La evidencia es obligatoria por defecto en el código PHP
-- No se requiere configuración adicional ya que está hardcodeada
